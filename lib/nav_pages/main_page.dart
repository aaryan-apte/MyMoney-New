...
import 'package:untitled1/home_pages/home_page.dart';
import 'package:untitled1/nav_pages/records_page.dart';
import 'package:untitled1/nav_pages/budgets_page.dart';
import 'package:untitled1/nav_pages/goals_page.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(label:("Records"),icon: Icon(Icons.newspaper)),
          BottomNavigationBarItem(label:("Budgets"),icon: Icon(Icons.calculate)),
